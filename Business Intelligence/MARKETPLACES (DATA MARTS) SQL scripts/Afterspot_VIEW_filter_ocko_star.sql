...
/*==============================================================*/
/* View: VIEW_FILTER_OCKOSTAR                                   */
/*==============================================================*/

drop view VIEW_FILTER_OCKOSTAR;

create view VIEW_FILTER_OCKOSTAR as
...
WHERE CHANNEL_CONTENT.CHANNEL_ID = '57ea31912bb6581000092e89'
AND ((USER_SESSION.SESSION_START <= CHANNEL_CONTENT.CONTENT_START
