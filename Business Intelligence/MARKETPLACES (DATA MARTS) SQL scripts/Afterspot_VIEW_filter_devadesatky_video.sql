...
/*==============================================================*/
/* View: VIEW_FILTER_DEVADESATKY_VIDEO                          */
/*==============================================================*/

drop view VIEW_FILTER_DEVADESATKY_VIDEO;

create view VIEW_FILTER_DEVADESATKY_VIDEO as
...
where 
    ((HOUR(CHANNEL_CONTENT.CONTENT_START) >=9
        and HOUR(CHANNEL_CONTENT.CONTENT_START) < 10) 
    or (HOUR(CHANNEL_CONTENT.CONTENT_START) >= 21 
        and HOUR(CHANNEL_CONTENT.CONTENT_START) < 22))
and
(CHANNEL_CONTENT.BCCATEGORY = 'VIDEO')
and
(CHANNEL_CONTENT.CHANNEL_ID = '57ea31912bb6581000092e89')
and 
