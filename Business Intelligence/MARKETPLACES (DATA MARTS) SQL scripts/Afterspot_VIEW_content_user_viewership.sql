...
/*==============================================================*/
/* View: VIEW_CONTENT_USER_VIEWERSHIP                           */
/*==============================================================*/
drop view VIEW_CONTENT_USER_VIEWERSHIP;

create view VIEW_CONTENT_USER_VIEWERSHIP as
...
from (select SESSION_ID, DU.DEVICEUSER_ID AS DEVICEUSER_ID, CHANNEL_ID, SESSION_START, SESSION_END, DURATION AS SESSION_DURATION, UAIPHASH  
    ...
    join (select CONTENT_ID, DURATION AS CONTENT_DURATION, CONTENT_END, CONTENT_START, CONTENT_TITLE, BCCATEGORY, BCID, ADID, CONTENT.CHANNEL_ID AS CHANNEL_ID, CHANNEL_NAME, ACTIVE AS ACTIVE_CHANNEL 
          ...
          where CONTENT_START < CONTENT_END
         ) CHANNEL_CONTENT
